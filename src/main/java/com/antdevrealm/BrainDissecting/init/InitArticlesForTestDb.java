...
//                .setTitle("Article 1")
//                .setAbstractText("Content 1")
//                .setAuthor("Author 1")
//                .setCategories(categoryRepository.save(new Category().setName("category 1").setArticles(new HashSet<>())))
//                .setPublishedOn(LocalDate.now());
//
//        Article article2 = new Article()
//                .setTitle("Article 2")
//                .setAbstractText("Content 2")
//                .setAuthor("Author 2")
//                .setCategories(categoryRepository.save(new Category().setName("category 2").setArticles(new HashSet<>())))
//                .setPublishedOn(LocalDate.now());
//
//        Article article3 = new Article()
//                .setTitle("Article 3")
//                .setAbstractText("Content 3")
//                .setAuthor("Author 3")
//                .setCategories(categoryRepository.save(new Category().setName("category 3").setArticles(new HashSet<>())))
//                .setPublishedOn(LocalDate.now());
//
